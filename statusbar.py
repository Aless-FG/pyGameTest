...
class StatusBar(pygame.sprite.Sprite):
    def __init__(self):
        ...
        self.surf = pygame.Surface((90, 66)) #  This surface is essentially a blank rectangle, 90 is the width
    ...
    def update_draw(self):
        ...
        displaysurface.blit(text3, (630, 37))
        displaysurface.blit(text4, (630, 52))